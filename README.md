...
| "O site da Michael Page (fontes 05 e 06) oferece algum curso, simulador ou ferramenta de prática para candidatos? Liste tudo que existe hoje." | Lista: Bootcamp "Criando seu primeiro Agente de IA" (parceria DIO, 25h de conteúdo); ferramenta interativa Talent Trends; seção de preparação para entrevistas; ferramenta/orientação de melhoria de currículo; testes psicométricos (dentro do Executive Assessment); Guia Salarial interativo; webinars e dicas de carreira. **Nota:** essa resposta generalizou além do que as fontes 05/06 (site scraped) literalmente mostram — ver "Dificuldade encontrada". | Cursos/bootcamp: vídeos "Lançamento Bootcamp", "Talent Trends 2026: o que mudou no mercado tech?" e "...crescimento e empregabilidade em tech?". Currículo/entrevista/webinars: seções "Candidatos"/"Carreira" do site. Testes psicométricos: seção "Executive Search" do site. | O NotebookLM generalizou: tratou "Bootcamp DIO", "webinars" e "seção de preparação para entrevistas" como parte do site, quando na verdade vêm dos vídeos (bootcamp) ou são leitura frouxa do blog "Advice" — não existe simulador de entrevista nem ferramenta de melhoria de currículo nas fontes 05/06 conforme scraping direto. | Reformulei com a variação de restrição de citação ("responda apenas com base nas fontes carregadas e cite o arquivo-fonte de cada afirmação") para separar o que é do site do que é dos vídeos — ver nota abaixo da tabela. |
| "Quais expectativas os recrutadores da Michael Page dizem ter dos candidatos que **não** são atendidas por nenhuma ferramenta hoje disponível no site da própria empresa?" | 5 expectativas puramente humanas, que nenhuma ferramenta simula: **(1) Bancar o repertório** — sustentar na entrevista o que está escrito no papel; quem depende de roteiro pronto trava quando a pergunta foge do script. **(2) Julgamento humano** — escolher entre opções técnicas, avaliar riscos e trade-offs, decidir arquitetura; depende de repertório real, não simulável. **(3) Conexão tecnologia-negócio-pessoas** — perfil "Business Partner de tecnologia", traduzir tecniquês pra áreas não técnicas, entender como o trabalho impacta cliente/receita/eficiência. **(4) Influência sem autoridade formal** — convencer, mobilizar, gerar alinhamento sem cargo de liderança. **(5) Responsabilidade e protagonismo** — assumir a liderança e consequência de um problema, não só executar tarefa delegada. | (1)/(2) Camilo e Júlia, vídeos "Lançamento Bootcamp" e "Talent Trends 2026: como se destacar...". (3)/(4)/(5) Júlia e Camilo, vídeos "Talent Trends 2026: o que mudou no mercado tech?" e "...o que sustenta crescimento e empregabilidade...". | Mesma cicatriz da pergunta 4: a resposta abriu aceitando como fato que "o site disponibiliza guias de entrevista, dicas de currículo, webinars e testes psicométricos" — repetindo a generalização não confirmada da resposta anterior (o NotebookLM parece ter reaproveitado a própria resposta prévia como premissa, em vez de reverificar contra as fontes 05/06). | O conteúdo central (as 5 expectativas humanas) está bem ancorado nos vídeos e bate com o miniguia da seção 4 — mantive. A premissa de abertura sobre o site eu descartei/ignorei ao trazer pra cá, pelo mesmo motivo já registrado na pergunta 4: precisa reverificação com a variação de restrição de citação. |
